...
class MenuRepository:
    ...
    def get_all_menus(self):
        """
        Récupère tous les menus de la base de données avec leurs relations 
        (thèmes, régimes, photos) formatés pour Jinja2.
        """
        ...
        try:
            ...
            for row in menus_raw:
                ...
                # Structuration en dictionnaire imbriqué (prêt pour Jinja2)
                menu_dict = {
                    'menu_id': row['menu_id'],
